...
OUTPUT_DIR = '/home/michigg/GIT/uni/2021-ma-michael-goetz-data/FrogsCalibration/Test2/Graphs/Calculations/GlobalMaxCalc'
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f"{OUTPUT_DIR}/analyse-2.log", mode='w'),
...
def plot_distances(dataframe: pd.DataFrame):
    ...
    Output.box_plot(
        '',
        # f'Deviations In dB(A) Between Frogs By Distance',
        result,
        file_path=f'{OUTPUT_DIR}/level1',
...
def main():
    ...
    clicks_per_device = audio_calcs.calculate_global_max(clicks_per_device)
    logger.info('Prepared Dataframe')
    ...
    plot_distances(clicks_per_device)
